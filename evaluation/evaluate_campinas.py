...
for SCAN, index in zip(scans, range(len(scans))):
    ...
    # load scans
    seg = nib.load(brainmask_path).get_data()
...
print(".................................................")
print("|", np.round(np.mean(dsc_list), 4), '\pm', np.round(np.std(dsc_list), 4),
      "|", np.round(np.mean(sens_list), 4), '\pm', np.round(np.std(sens_list), 4),
      "|", np.round(np.mean(spec_list), 4), '\pm', np.round(np.std(spec_list), 4))
print(".................................................")
